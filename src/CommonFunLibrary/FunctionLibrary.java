...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Exception{
		...
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
			System.setProperty("webdriver.chrome.driver","D:\\sadhana\\StockAccounting\\drivers\\chromedriver.exe");
	...
	public static void captureData(WebDriver driver,String locatortype,String locatorvalue) throws Exception{
		...
		FileWriter fw=new FileWriter("D:\\sadhana\\StockAccountingHybrid\\CaptureData\\suppnumber.txt");
	...
	public static void tableValidation(WebDriver driver,String column) throws Exception{
		FileReader fr=new FileReader("D:\\sadhana\\StockAccountingHybrid\\CaptureData\\suppnumber.txt");
